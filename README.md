# YNAB.Dotnet - A C# library for the YNAB API Endpoints
...
<a name="adaptation"></a>
## Swagger Codegen Adaptation
The code generated by Swagger Codegen has been adapted to function as a .NET Standard 2.0 library. Additionally its dependencies have been updated to more current versions.

<a name="frameworks-supported"></a>
## Frameworks supported
- .NET Standard 2.0 (and all frameworks that implement .NET Standard 2.0)
...
## Installation
Simply add the published [Nuget package](https://www.nuget.org/packages/YNAB.Dotnet/) to your project.
